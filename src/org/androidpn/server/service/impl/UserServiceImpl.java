...
public class UserServiceImpl implements UserService {
    ...
    public static void main(String[] args) {
    	Log log = LogFactory.getLog("UserServiceImpl");
    	log.info("spring load begin");
    	ApplicationContext ac = new FileSystemXmlApplicationContext("resources/spring-config.xml");
    	log.info("spring load end");
